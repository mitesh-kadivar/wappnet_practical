        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a class="btn btn-info float-right" href="{{ url('/customer/checkout') }}"> Checkout</a>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <a href="{{ url('/customer/press-order/' . $product->id) }}" class="btn btn-success btn-block" id="press-order">Press order</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        var url = '{{ url("/customer/dashboard/:id") }}';
